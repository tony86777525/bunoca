    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/uploads/{{$product->p_image}}" class="d-block w-100 top-img" alt="...">
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-12 space bg-light card">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 wow fadeIn" data-wow-delay="0.6s">
                        <p class='text-right wow fadeInLeft price'>{{$ps->ps_price > 0 ? $ps->ps_price : $product->p_price}}đ</p>
                    ...
                    @if($ps->ps_image)
                        <div class="col-12 col-md-6 wow fadeIn" data-wow-delay="1.2s">
                            <div class="pic">
                                <a href="{{$ps->ps_href}}" target="_blank"><img class="img-responsive" width="100%" src="/uploads/{{$ps->ps_image}}"></a>
                            </div>
                        </div>
                    @endif
                </div>
